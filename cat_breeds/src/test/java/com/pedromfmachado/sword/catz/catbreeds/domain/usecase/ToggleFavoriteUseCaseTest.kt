...
class ToggleFavoriteUseCaseTest {
    ...
    @Test
    fun `invoke adds favorite and returns true when currently not favorite`() = runTest {
    ...
    @Test
    fun `invoke removes favorite and returns false when currently favorite`() = runTest {
