...
class BreedEntityMapper
    ...
    constructor() {
        ...
        fun mapToDomain(entities: List<BreedEntity>): List<Breed> = entities.map { mapToDomain(it) }
        ...
        fun mapToEntities(breeds: List<Breed>): List<BreedEntity> = breeds.map { mapToEntity(it) }
    }
